...
export function getIcon(icon, alt = icon, size = 44) {
  ...
  */
  const symbols = ['remove-background', 'mobile-round', 'desktop-round', 'elements', 'text',
    ...
    'templates', 'blank', 'premium-templates', 'resize', 'stickers',
    ...
    'pinterest', 'instagram', 'linkedin', 'sparkpage', 'sparkvideo', 'image', 'rush', 'check',
    'users', 'brandswitch', 'library', 'magicwand', 'animation'];
